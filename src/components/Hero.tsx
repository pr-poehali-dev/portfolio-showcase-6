        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-block bg-muted text-accent font-medium py-1 px-4 rounded-full text-sm animate-fade-in">
              <Icon name="Wave" className="inline-block mr-2 h-4 w-4" /> Приветствую!
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-playfair leading-tight">
              Создаю <span className="text-primary">впечатляющие</span> цифровые решения
            </h1>
            
            <p className="text-lg text-foreground/80 max-w-lg">
              Я специализируюсь на разработке удобных и продуманных интерфейсов, 
              которые решают бизнес-задачи и радуют пользователей.
            </p>
