      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-foreground/70 text-lg">
            Заинтересованы в сотрудничестве? Отправьте сообщение или свяжитесь через социальные сети
          </p>
        </div>
          ...
          <Card className="border-0 shadow-lg overflow-hidden">
            <CardContent className="p-0">
              <div className="bg-primary p-8 text-center text-primary-foreground">
                ...
                <h3 className="text-2xl font-bold mb-2">Контактная информация</h3>
                <p className="opacity-90 mb-6">Свяжитесь со мной для обсуждения проектов и сотрудничества</p>
            ...
            <CardContent className="p-8">
              ...
              <form className="space-y-4">
                ...
                <Button type="submit" className="w-full">
                  Отправить сообщение <Icon name="Send" className="ml-2 h-4 w-4" />
                </Button>
              </form>
            </CardContent>
          </Card>
